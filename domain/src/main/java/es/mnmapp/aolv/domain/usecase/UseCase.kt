 ...
 */
abstract class UseCase<T, in Params> internal constructor(val postExecutionThread : Scheduler) {
    ...
    fun execute(observer : DisposableObserver<T>, params : Params) {
        val observable = this.buildUseCaseObservable(params).subscribeOn(Schedulers.io()).observeOn(
                postExecutionThread)
